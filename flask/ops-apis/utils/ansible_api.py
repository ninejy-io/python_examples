...
from config import NODE_GROUP_NAME, BASE_DIR
host_list_file = os.path.join(BASE_DIR, 'hosts')
...
class MyInventory:
    ...
    def dynamic_inventory(self):
        if isinstance(self.resource, list):
            self.add_dynamic_group(self.resource, NODE_GROUP_NAME)
...
class AnsibleRunner(object):
    ...
    def __initializeData(self):
        ...
        self.loader = DataLoader()
        self.options = Options(connection='smart',module_path=None,forks=10,timeout=10,remote_user='root',ask_pass=False,
                            private_key_file=None,ssh_common_args=None,ssh_extra_args=None,sftp_extra_args=None,scp_extra_args=None,
                            become=None,become_method=None,become_user='root',ask_value_pass=False,verbosity=None,check=False,listhosts=False,
